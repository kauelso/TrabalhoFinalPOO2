...
public class SpaceInvadersBoard extends AbstractBoard{  
    ...
    public SpaceInvadersBoard() {
        super(Commons.BOARD_WIDTH, Commons.BOMB_HEIGHT, Color.black);
    }
    ...
    protected Player createPlayer() {
        return new Player("/images/player.png", Commons.PLAYER_WIDTH, Commons.PLAYER_HEIGHT,
                Commons.INIT_PLAYER_X,Commons.INIT_PLAYER_Y);
    }
